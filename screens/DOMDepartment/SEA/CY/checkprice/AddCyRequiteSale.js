...
import clientCheckPriceCy from "../../../../../api/clientCheckPriceCy";
import clientSeaCy from "../../../../../api/clientSeaCy";

const AddCyRequiteSale = ({ navigation, route }) => {
  const [error, setError] = useState("");
  const [seaCyInfo, setSeaCyInfo] = useState(route.params.item);
  ...
  const submitForm = async () => {
    ...
    try {
      ...
      const res1 = await clientCheckPriceCy.delete(url + id);
...
export default AddCyRequiteSale;

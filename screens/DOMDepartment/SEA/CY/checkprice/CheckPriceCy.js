        ...
        Alert.alert(
          ...
          [
            ...
            },
            {
              text: "Phản hồi",
              onPress: () => {
                navigation.navigate("AddCyRequiteSale", {
                  item: item,
                });
              },
            },
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "white" }}>
      ...
      <View style={{ flex: 0.5, marginBottom: 20 }}>
        <TouchableOpacity
          onPress={() => {
            navigation.navigate("AddCheckPriceCy");
          }}
        >

...
import AddCheckPriceImport from "./checkprice/AddCheckPriceImport";
...
const ScreenImport = () => {
  return (
    ...
    <Stack.Navigator>
      ...
      />
      <Stack.Screen
        name="AddCheckPriceImport"
        component={AddCheckPriceImport}
        options={{ headerShown: false }}
      />
    </Stack.Navigator>
    // </NavigationContainer>
